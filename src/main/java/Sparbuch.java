...
public class Sparbuch extends Konto {
    ...
    /**
     * Kontostand und bereitsAbgehoben werden in neue Währung umgerechnet
     *
    ...
    public void waehrungswechsel(Waehrung neu) {
        if (super.getAktuelleWaehrung() != neu) {
            bereitsAbgehoben = super.getAktuelleWaehrung()
                    .waehrungInWaehrungUmrechnen(bereitsAbgehoben, neu);
